...
对于发布到 `Google Play` 或者 `App Store` 的应用，需要提供一份隐私政策的说明，如果不知道怎么写的话推荐一个在线的网站来自动生成隐私政策。通过 [App Privacy Policy Generator](https://app-privacy-policy-generator.firebaseapp.com/) 只需填写一些关键信息即可生成一份隐私政策说明，最终效果如下：
